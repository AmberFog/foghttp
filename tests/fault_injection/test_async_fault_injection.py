...
async def test_async_healthy_fault_server_route_reuses_keepalive_connection(
...
async def test_async_clean_response_with_connection_close_records_closed_body(
    fault_injection_server: FaultInjectionServer,
) -> None:
