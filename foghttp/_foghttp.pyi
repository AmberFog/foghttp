...
class FogHttpNetworkError(FogHttpError): ...
class FogHttpSsrfError(FogHttpError): ...
...
class FogHttpLifecycleError(FogHttpError): ...
...
class RawRetryAttempt:
    ...
    @property
    def decision_elapsed(self) -> float | None: ...
    @property
    def completed_elapsed(self) -> float: ...

class RawRetryTrace:
    @property
    def attempts(self) -> list[RawRetryAttempt]: ...
    @property
    ...
    @property
    def terminal_error_on_last_attempt(self) -> bool: ...
...
class RawResponse:
    ...
    @property
    def retry_trace(self) -> RawRetryTrace | None: ...
...
class RawStats:
    ...
    @property
    def connection_acquire_attempts(self) -> int: ...
    @property
    def connection_acquire_immediate(self) -> int: ...
    @property
    def connection_acquire_waited(self) -> int: ...
    @property
    def connection_acquire_timeouts(self) -> int: ...
    @property
    def connection_acquire_wait_time_total_ns(self) -> int: ...
    @property
    def connection_acquire_wait_time_max_ns(self) -> int: ...
    @property
    def connection_acquire_wait_time_last_ns(self) -> int: ...
    @property
    ...
    @property
    def idle_timeout_evictions(self) -> int: ...
    @property
...
class RawProxyEndpointDiagnostics:
    @property
    ...
    def active_connections(self) -> int: ...
    @property
    def tunnel_attempts(self) -> int: ...
    @property
    def tunnels_established(self) -> int: ...
    @property
    def tunnel_failures(self) -> int: ...
    @property
    def tunnel_auth_failures(self) -> int: ...
    @property
    def tunnel_timeouts(self) -> int: ...
    @property
    def tunnel_early_closes(self) -> int: ...
    @property
    def active_tunnels(self) -> int: ...
    @property
    def last_activity_at_ns(self) -> int: ...

class RawProxyDiagnostics:
    @property
    def schema_version(self) -> int: ...
    @property
    def snapshot_sequence(self) -> int: ...
    @property
    def endpoints(self) -> Sequence[RawProxyEndpointDiagnostics]: ...
...
class RawClient:
    ...
    def proxy_diagnostics(self) -> RawProxyDiagnostics: ...
    def drain_telemetry_events(
        self,
        request_id: int | None = None,
    ) -> tuple[list[RawTelemetryEvent], int]: ...
    def close(self) -> None: ...
